...
class PersonDetect:
    ...
    def predict(self, image):
        # prerocessing the image using the helper function
        self.processed_image=self.preprocess_input(image)
        # synchronous inference and getting the result
    ...
    def draw_outputs(self, detections, image):
        ...
        for obj in detections[0][0]: 
            # obj[2] contains the confidence of model, so i will use that
            conf = obj[2]
    ...
    def preprocess_outputs(self, outputs):
        # converting image back to original shape
